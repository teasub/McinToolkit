...
public class ThreadUtils {
	...
	/**
	 * 一个带looper的，后台线程。 主要是提供给handler用在一些性能， 级别不高的地方
	 * 
	 */
	private static final HandlerThread sInternalWorkHandler = new HandlerThread(
			"workHandler", Process.THREAD_PRIORITY_BACKGROUND);
	...
	/**
	 * 获取一个全局的，后台使用的HandlerThread. 主要是提供给handler用在一些性能， 级别不高的地方
	 * 
	 * @return
	 */
	...
	public static void cancelAsyncTask(
			@SuppressWarnings("rawtypes") AsyncTask task) {
