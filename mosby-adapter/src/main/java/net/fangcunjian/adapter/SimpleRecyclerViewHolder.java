...
public class SimpleRecyclerViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener, View.OnLongClickListener {
    ...
    public SimpleRecyclerViewHolder(RecyclerView recyclerView, View itemView, SimpleOnRVItemClickListener onRVItemClickListener, SimpleOnRVItemLongClickListener onRVItemLongClickListener) {
        super(itemView);
        ...
        mViewHolderHelper = new SimpleViewHolderHelper(mRecyclerView, this.itemView);
