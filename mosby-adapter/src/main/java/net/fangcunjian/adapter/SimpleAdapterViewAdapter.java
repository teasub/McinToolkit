/**
 * Copyright 2016 Mcin(teajosn@gmail.com)
 * <p/>
 ...
 * AdapterView适配器
 */
public abstract class SimpleAdapterViewAdapter<M> extends BaseAdapter {
    ...
    public SimpleAdapterViewAdapter(Context context, int itemLayoutId) {
        mContext = context;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        final SimpleAdapterViewHolder viewHolder = SimpleAdapterViewHolder.dequeueReusableAdapterViewHolder(convertView, parent, mItemLayoutId);
